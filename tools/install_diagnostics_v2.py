...
ROOT_TAG = '<script src="diagnostics-v2.js?v=20260903-19"></script>'
...
for old in ('diagnostics-v2.js?v=20260903-14','diagnostics-v2.js?v=20260903-15','diagnostics-v2.js?v=20260903-16','diagnostics-v2.js?v=20260903-17','diagnostics-v2.js?v=20260903-18'):
    root = root.replace(old,'diagnostics-v2.js?v=20260903-19')
